...
tools = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "해당 종목의 Uahoo Finance 정보를 반환합니다.",
            "parameters": {
                "type": "object",
                "properties": {
                    'ticker': {
                        'type': 'string',
                        'description': f'Yahoo Finance 정보를 반환할 종목의 티커를 입력하세요. (예: AAPL)'
                    }
                },
                "required": ['ticker'],
            },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    'ticker': {
                        'type': 'string',
                        'description': f'Yahoo Finance 주가 정보를 반환할 종목의 티커를 입력하세요. (예: AAPL)'
                    },
                    'period': {
                        'type': 'string',
                        'description': f'주가 정보를 조회할 기간을 입력하세요. (예: 1d, 5d, 1mo, 1y, 5y)',
                    },
                },
